...
# ---------------------------------------------------------
# 1. CẤU HÌNH TRANG & TÍCH HỢP ICON KHỐI BĂNG CHO ĐIỆN THOẠI
# ---------------------------------------------------------
...
st.set_page_config(
    page_title="Hệ Thống Quản Lý Kho Cấp Đông", 
...
# ---------------------------------------------------------
# 2. CẤU HÌNH CƠ SỞ DỮ LIỆU & HỆ THỐNG
# ---------------------------------------------------------
UPLOAD_DIR = "uploads"
...
# ---------------------------------------------------------
# 4. GIAO DIỆN CHÍNH (CHUẨN GỐC BAN ĐẦU)
# ---------------------------------------------------------
